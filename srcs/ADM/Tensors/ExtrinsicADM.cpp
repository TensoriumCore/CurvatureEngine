...
/*     double beta_p = grid_obj.getCell(i + (dim == 0), j + (dim == 1), k + (dim == 2)).gauge.beta[beta_index]; */
/*     double beta_m = grid_obj.getCell(i - (dim == 0), j - (dim == 1), k - (dim == 2)).gauge.beta[beta_index]; */
/*  */
